$('#dodajForm').submit(function(){
    ...
    request.done(function(response, textStatus, jqXHR){
        ...
        if(textStatus == "success"){
            ...
            console.log("Termin zakazan");
            location.reload(true);
        }else console.log("Termin nije zakazan " + response);
        console.log(response);
...
$('#btn-izmeni').click(function () {
    ...
    request.done(function (response, textStatus, jqXHR) {
        ...
        $('#kozmetickisalon').val(response[0]['kozmetickisalon']);
        console.log(response[0]['kozmetickisalon']);
        ...
        $('#kozmeticar').val(response[0]['kozmeticar'].trim());
...
$('#izmeniForm').submit(function () {
    ...
    request.done(function (response,textStatus,jqXHR) {
        ...
        if (response == "Success") {
            console.log('Termin je azuriran');
            location.reload(true);
            $('#izmeniForm').reset;
        }
        else console.log('Termin nije azuriran ' + response);
        console.log(response);
    });
...
$('#btn-obrisi').click(function(){
    ...
    req.done(function(res, textStatus, jqXHR){
        ...
        console.log("Termin nije otkazan "+res);
        alert("Termin nije otkazan");
